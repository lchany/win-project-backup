...
OUT=${STEP307_OUT:?STEP307_OUT is required}
...
export MODE=single
export MAX_ITERS=30
export MASTER_PORT=30162
export HCCL_IF_BASE_PORT=${HCCL_IF_BASE_PORT:-64220}
...
{
  echo "STEP307_START $(date -Iseconds)"
...
echo "STEP307_END rc=$rc $(date -Iseconds)" >>"$OUT/logs/launcher.log"
exit $rc

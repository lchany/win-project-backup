...
def main() -> int:
    ...
    remote_dir = str(info["shared"]).rstrip("/") + "/" + REL
...
echo HOST_PORTS
ss -ltnp 2>/dev/null | grep -E ':(30141|30142|6000[0-9]|6400[0-9])\\b' || true
echo CONTAINER_PORTS
docker exec mapqr-leicheng bash --noprofile --norc -lc "ss -ltnp 2>/dev/null | grep -E ':(30141|30142|6000[0-9]|6400[0-9])\\b' || true" 2>/dev/null || true
"""

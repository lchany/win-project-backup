...
echo PREFLIGHT_TAIL
tail -n 80 "$DIR/logs/device_preflight.log" 2>/dev/null || true
echo PREFLIGHT_HEAD
head -n 30 "$DIR/logs/device_preflight.log" 2>/dev/null || true
echo HOST_PORTS
ss -ltnp 2>/dev/null | grep -E ':(30151|30152|6412[0-9]|6413[0-9])\b' || true
echo CONTAINER_PORTS
docker exec mapqr-leicheng bash --noprofile --norc -lc "ss -ltnp 2>/dev/null | grep -E ':(30151|30152|6412[0-9]|6413[0-9])\b' || true" 2>/dev/null || true

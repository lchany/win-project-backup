...
def main() -> int:
    ...
    try:
        ...
        precheck = (
            ...
            "! ss -ltn | grep -q ':30131 ' && ! ss -ltn | grep -q ':30132 ' && "
        ...
        command = (
            ...
            f"setsid -f sh -c 'docker exec -e STEP303_OUT={remote_dir} mapqr-leicheng "
            f"bash --noprofile --norc {remote_dir}/step303_launch_inside.sh' </dev/null; echo started"
        )
